        ...
        <div className={styles.services}>
            ...
            <div className={styles.servicesBox__dawn}>
                <div className={styles.servicesBox__delivery}>
                    <img src={delivery} alt="" className={styles.servicesBox__deliveryImg} />
                        <p className={styles.servicesBox__deliveryText}>Доставка</p>
                </div>
                <div className={styles.servicesBox__installation}>
                    <img src={installation} alt="" className={styles.servicesBox__installationImg} />
                        <p className={styles.servicesBox__installationText}>Сборка и установка</p>
                </div>
            </div>
        </div>
    );
