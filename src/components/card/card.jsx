                ...
                <div className={styles.cardHolder}>
                    ...
                    <div className={styles.cardTableAll}>
                        ...
                        <div className={styles.cardText__table}>
                            ...
                            <p className={styles.cardText__price}><b>12 650 ₽</b><small> <s>14 200 ₽</s></small></p>
                            <button className={`${styles.cardText__basket} ${styles.styled}`}
                                    type="button">
                                Добавить в корзину
                            </button>
                    ...
                    <div className={`${styles.cardChairOll} ${styles.cardMobile__switch}`}>
                        ...
                        <div className={styles.cardText__chair}>
                            ...
                            <p className={styles.cardText__nameText}>Коломбо с подлокотниками</p>
                            <p className={styles.cardText__price}><b>6 150 ₽</b> <small><s> 7 640 ₽</s></small></p>
                            <button className={`${styles.cardText__basket} ${styles.styled}`}
                                    type="button">
                                Добавить в корзину
                            </button>
                    ...
                    <div className={styles.cardBed__oll}>
                        ...
                        <div className={styles.cardText__bed}>
                            ...
                            <p className={styles.cardText__price}><b>13 390 ₽</b><small> <s> 15 480 ₽</s></small></p>
                            <button className={`${styles.cardText__basket} ${styles.styled}`}
                                    type="button">
                                Добавить в корзину
                            </button>
